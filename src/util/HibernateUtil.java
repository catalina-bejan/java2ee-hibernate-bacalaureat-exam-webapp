    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                configuration.addAnnotatedClass(Liceu.class);
                configuration.addAnnotatedClass(LiceuProfil.class);
                configuration.addAnnotatedClass(Elev.class);
                configuration.addAnnotatedClass(Profil.class);
                configuration.addAnnotatedClass(Rezultat.class);
